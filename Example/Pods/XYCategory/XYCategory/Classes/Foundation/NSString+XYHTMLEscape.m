...
@implementation NSString (XYHTMLEscape)

- (NSString *)xy_stringByEscapingHTMLUsingTable:(HTMLEscapeMap*)table
...
{
    return [self xy_stringByEscapingHTMLUsingTable:gUnicodeHTMLEscapeMap
...
{
    return [self xy_stringByEscapingHTMLUsingTable:gAsciiHTMLEscapeMap
