...
CGRect XYYYCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode) {
...
@implementation UIImage (XYResize)
...
- (UIImage *)xy_roundCornerImageByRadius:(CGFloat)radius {
    return [self xy_roundCornerImageByRadius:radius borderWidth:0 borderColor:nil];
}

- (UIImage *)xy_roundCornerImageByRadius:(CGFloat)radius
                             borderWidth:(CGFloat)borderWidth
                             borderColor:(nullable UIColor *)borderColor {
    return [self xy_roundCornerImageByRadius:radius
...
- (void)_drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips{
    CGRect drawRect = XYYYCGRectFitWithContentMode(rect, self.size, contentMode);
