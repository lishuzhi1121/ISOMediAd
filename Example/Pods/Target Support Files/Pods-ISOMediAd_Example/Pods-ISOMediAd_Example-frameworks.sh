...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/XYCategory/XYCategory.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/XYMediEventAdapter/XYMediEventAdapter.framework"
