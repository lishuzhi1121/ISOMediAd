...
/// 广告源数据
@interface XYAdPlatformConfigDataAdModel : NSObject
...
/// 广告配置数据
@interface XYAdPlatformConfigDataModel : NSObject
...
//非必须
//广告列表
@property (nonatomic, strong) NSArray<XYAdPlatformConfigDataAdModel *> *ad;
